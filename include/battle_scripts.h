...
extern const u8 BattleScript_MoveUsedIsParalysed[];
...
extern const u8 BattleScript_MoveUsedIsParalysedCantAttack[];
...
extern const u8 BattleScript_StatusPrevention[];
...
extern const u8 BattleScript_ActiveTerrainPreventsMoveEnd[];
