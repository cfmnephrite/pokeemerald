...
extern const u32 gHealthboxPlayerGfx[];
extern const u32 gHealthboxOpponentGfx[];
extern const u32 gHealthboxSafariGfx[];
extern const u32 gBlankGfxCompressed[];
extern const u16 gBattleInterface_BallStatusBarPal[];
extern const u16 gBattleInterface_BallDisplayPal[];

extern const u32 gTypeBgBug_Gfx[];
extern const u32 gTypeBgDark_Gfx[];
extern const u32 gTypeBgDragon_Gfx[];
extern const u32 gTypeBgElectric_Gfx[];
extern const u32 gTypeBgFairy_Gfx[];
extern const u32 gTypeBgFighting_Gfx[];
extern const u32 gTypeBgFire_Gfx[];
extern const u32 gTypeBgFlying_Gfx[];
extern const u32 gTypeBgGhost_Gfx[];
extern const u32 gTypeBgGrass_Gfx[];
extern const u32 gTypeBgGround_Gfx[];
extern const u32 gTypeBgIce_Gfx[];
extern const u32 gTypeBgNormal_Gfx[];
extern const u32 gTypeBgPoison_Gfx[];
extern const u32 gTypeBgPsychic_Gfx[];
extern const u32 gTypeBgRock_Gfx[];
extern const u32 gTypeBgSteel_Gfx[];
extern const u32 gTypeBgWater_Gfx[];

extern const u16 gTypeBgBug_Pal[];
extern const u16 gTypeBgDark_Pal[];
extern const u16 gTypeBgDragon_Pal[];
extern const u16 gTypeBgElectric_Pal[];
extern const u16 gTypeBgFairy_Pal[];
extern const u16 gTypeBgFighting_Pal[];
extern const u16 gTypeBgFire_Pal[];
extern const u16 gTypeBgFlying_Pal[];
extern const u16 gTypeBgGhost_Pal[];
extern const u16 gTypeBgGrass_Pal[];
extern const u16 gTypeBgGround_Pal[];
extern const u16 gTypeBgIce_Pal[];
extern const u16 gTypeBgNormal_Pal[];
extern const u16 gTypeBgPoison_Pal[];
extern const u16 gTypeBgPsychic_Pal[];
extern const u16 gTypeBgRock_Pal[];
extern const u16 gTypeBgSteel_Pal[];
extern const u16 gTypeBgWater_Pal[];
...
// Battle move boxes
extern const u32 gBattleMoveBoxMystery_Gfx[];
extern const u32 gBattleMoveBoxBug_Gfx[];
extern const u32 gBattleMoveBoxDark_Gfx[];
extern const u32 gBattleMoveBoxDragon_Gfx[];
extern const u32 gBattleMoveBoxElectric_Gfx[];
extern const u32 gBattleMoveBoxFairy_Gfx[];
extern const u32 gBattleMoveBoxFighting_Gfx[];
extern const u32 gBattleMoveBoxFire_Gfx[];
extern const u32 gBattleMoveBoxFlying_Gfx[];
extern const u32 gBattleMoveBoxGhost_Gfx[];
extern const u32 gBattleMoveBoxGrass_Gfx[];
extern const u32 gBattleMoveBoxGround_Gfx[];
extern const u32 gBattleMoveBoxIce_Gfx[];
extern const u32 gBattleMoveBoxNormal_Gfx[];
extern const u32 gBattleMoveBoxPoison_Gfx[];
extern const u32 gBattleMoveBoxPsychic_Gfx[];
extern const u32 gBattleMoveBoxRock_Gfx[];
extern const u32 gBattleMoveBoxSteel_Gfx[];
extern const u32 gBattleMoveBoxWater_Gfx[];
extern const u32 gBattleMoveBoxRightHalf_Gfx[];
extern const u32 gBattleMoveBoxCursor[];

extern const u16 gBattleMoveBoxBug_Pal[];
extern const u16 gBattleMoveBoxDark_Pal[];
extern const u16 gBattleMoveBoxDragon_Pal[];
extern const u16 gBattleMoveBoxElectric_Pal[];
extern const u16 gBattleMoveBoxFairy_Pal[];
extern const u16 gBattleMoveBoxFighting_Pal[];
extern const u16 gBattleMoveBoxFire_Pal[];
extern const u16 gBattleMoveBoxFlying_Pal[];
extern const u16 gBattleMoveBoxGhost_Pal[];
extern const u16 gBattleMoveBoxGrass_Pal[];
extern const u16 gBattleMoveBoxGround_Pal[];
extern const u16 gBattleMoveBoxIce_Pal[];
extern const u16 gBattleMoveBoxNormal_Pal[];
extern const u16 gBattleMoveBoxPoison_Pal[];
extern const u16 gBattleMoveBoxPsychic_Pal[];
extern const u16 gBattleMoveBoxRock_Pal[];
extern const u16 gBattleMoveBoxSteel_Pal[];
extern const u16 gBattleMoveBoxWater_Pal[];
