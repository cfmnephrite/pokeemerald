...
#define SET_BATTLER_VOLATILES(battler, volatile1, ...) MACRO_BATTLER_VOLATILES(Set, battler, volatile1, __VA_ARGS__)
#define CHECK_BATTLER_VOLATILES(battler, volatile1, ...) MACRO_BATTLER_VOLATILES(Check, battler, volatile1, __VA_ARGS__)
#define REMOVE_BATTLER_VOLATILES(battler, volatile1, ...) MACRO_BATTLER_VOLATILES(Remove, battler, volatile1, __VA_ARGS__)
