...
extern const u8 gText_SideWithAqua[];
extern const u8 gText_SideWithMagma[];
extern const u8 gText_Leave[];
extern const u8 gText_TheGymSystem[];
extern const u8 gText_TheNormalType[];
extern const u8 gText_NothingForNow[];
