...
#define MULTI_PETALBURG_GYM_GUIDE          47
...
#define MULTI_AQUA_VS_MAGMA                89
#define MULTI_UNUSED_SSTIDAL_2             90 // These 3 were replaced by CreateLilycoveSSTidalMultichoice
