...
#define TRAINER_BATTLE_VICTORY_TEXT_SINGLE                          13
#define TRAINER_BATTLE_VICTORY_TEXT_SINGLE_CONTINUE_SCRIPT          14
#define TRAINER_BATTLE_VICTORY_TEXT_SINGLE_CONTINUE_SCRIPT_NO_MUSIC 15
