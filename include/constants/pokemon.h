...
#define FLAG_MAGICIAN_AFFECTED      (1 << 5)
...
#define FLAG_THAWS_USER             (1 << 11)
#define FLAG_STAT_STAGES_IGNORED    (1 << 12)
#define FLAG_ANTI_AIR               (1 << 13)
#define FLAG_MAGIC                  (1 << 14)
#define FLAG_OMNITYPE               (1 << 15)
...
#define FLAG_MON_EXCLUSIVE          (1 << 21)
#define FLAG_SPECIAL_TYPEMOD        (1 << 22)
#define FLAG_TARGET_ABILITY_IGNORED (1 << 23)
#define FLAG_HEAD                   (1 << 24)
#define FLAG_SELF_Z                 (1 << 25)
#define FLAG_Z_SPECIAL              (1 << 26)
#define FLAG_Z_MOVE                 (1 << 27)
#define FLAG_DMG_IN_AIR             (1 << 28) // X2 dmg on air, always hits target on air
#define FLAG_HIT_IN_AIR             (1 << 29) // dmg is normal, always hits target on air
#define FLAG_IGNORE_REDIRECTION     (1 << 30)
