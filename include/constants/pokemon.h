...
#define FLAG_MULTIHIT_CHECKS_ACCURACY             (1 << 6)
#define FLAG_IRON_FIST_BOOST                      (1 << 7)
#define FLAG_SHEER_FORCE_BOOST                    (1 << 8)
#define FLAG_STRONG_JAW_BOOST                     (1 << 9)
#define FLAG_MEGA_LAUNCHER_BOOST                  (1 << 10)
#define FLAG_STAT_STAGES_IGNORED                  (1 << 11)
#define FLAG_DMG_MINIMIZE                         (1 << 12)
#define FLAG_DMG_UNDERGROUND                      (1 << 13)
#define FLAG_DMG_UNDERWATER                       (1 << 14)
#define FLAG_SOUND                                (1 << 15)
#define FLAG_BALLISTIC                            (1 << 16)
#define FLAG_PROTECTION_MOVE                      (1 << 17)
#define FLAG_POWDER                               (1 << 18)
#define FLAG_TARGET_ABILITY_IGNORED               (1 << 19)
#define FLAG_DANCE                                (1 << 20)
#define FLAG_DMG_2X_IN_AIR                        (1 << 21)// If target is in the air
#define FLAG_DMG_IN_AIR                           (1 << 22) // If target is in the air
#define FLAG_DMG_UNGROUNDED_IGNORE_TYPE_IF_FLYING (1 << 23) // Makes a Ground type move do 1x damage to flying and levitating targets
#define FLAG_THAW_USER                            (1 << 24) 
#define FLAG_HIT_IN_SUBSTITUTE                    (1 << 25)// Hyperspace Fury
#define FLAG_WIND_MOVE                            (1 << 26) 
#define FLAG_SLICING_MOVE                         (1 << 27)
