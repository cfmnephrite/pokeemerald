...
// Gen7 moves.
#define MOVE_BREAKNECK_BLITZ 622
#define MOVE_Z_NORMAL_2 623
#define MOVE_ALL_OUT_PUMELLING 624
#define MOVE_HP_FIGHTING 625
#define MOVE_SUPERSONIC_SKYSTRIKE 626
#define MOVE_HP_FLYING 627
#define MOVE_ACID_DOWNPOUR 628
#define MOVE_HP_POISON 629
#define MOVE_TECTONIC_RAGE 630
#define MOVE_HP_GROUND 631
#define MOVE_CONTINENTAL_CRUSH 632
#define MOVE_HP_ROCK 633
#define MOVE_SAVAGE_SPIN_OUT 634
#define MOVE_HP_BUG 635
#define MOVE_NEVER_ENDING_NIGHTMARE 636
#define MOVE_HP_GHOST 637
#define MOVE_CORKSCREW_CRASH 638
#define MOVE_HP_STEEL 639
#define MOVE_INFERNO_OVERDRIVE 640
#define MOVE_HP_FIRE 641
#define MOVE_HYDRO_VORTEX 642
#define MOVE_HP_WATER 643
#define MOVE_BLOOM_DOOM 644
#define MOVE_HP_GRASS 645
#define MOVE_GIGAVOLT_HAVOC 646
#define MOVE_HP_ELECTRIC 647
#define MOVE_SHATTERED_PSYCHE 648
#define MOVE_Z_PSYCHIC_2 649
#define MOVE_SUBZERO_SLAMMER 650
#define MOVE_HP_ICE 651
#define MOVE_DEVASTATING_DRAKE 652
#define MOVE_HP_DRAGON 653
#define MOVE_BLACK_HOLE_ECLIPSE 654
#define MOVE_HP_DARK 655
#define MOVE_TWINKLE_TACKLE 656
#define MOVE_HP_FAIRY 657
...
#define MOVE_PULVERISING_PANCAKE 701
...
#define MOVE_10_000_000_VOLT_THUNDERBOLT 719
...
#define MOVE_LGPE_1 729
#define MOVE_LGPE_2 730
#define MOVE_LGPE_3 731
#define MOVE_LGPE_4 732
#define MOVE_LGPE_5 733
#define MOVE_LGPE_6 734
#define MOVE_LGPE_7 735
#define MOVE_LGPE_8 736
#define MOVE_LGPE_9 737
#define MOVE_LGPE_10 738
#define MOVE_LGPE_11 739
#define MOVE_LGPE_12 740
#define MOVE_LGPE_13 741
#define MOVE_DOUBLE_IRON_BASH 742

#define MOVES_COUNT_GEN7 743

// Gen 8 moves.
#define MOVE_APPLE_ACID            (MOVES_COUNT_GEN7 + 0)
#define MOVE_AURA_WHEEL            (MOVES_COUNT_GEN7 + 1)
#define MOVE_BEHEMOTH_BASH            (MOVES_COUNT_GEN7 + 2)
#define MOVE_BEHEMOTH_BLADE            (MOVES_COUNT_GEN7 + 3)
#define MOVE_BODY_PRESS            (MOVES_COUNT_GEN7 + 4)
#define MOVE_BOLT_BEAK            (MOVES_COUNT_GEN7 + 5)
#define MOVE_BRANCH_POKE            (MOVES_COUNT_GEN7 + 6)
#define MOVE_BREAKING_SWIPE            (MOVES_COUNT_GEN7 + 7)
#define MOVE_BURNING_JEALOUSY            (MOVES_COUNT_GEN7 + 8)
#define MOVE_CLANGOROUS_SOUL            (MOVES_COUNT_GEN7 + 9)
#define MOVE_COACHING            (MOVES_COUNT_GEN7 + 10)
#define MOVE_CORROSIVE_GAS            (MOVES_COUNT_GEN7 + 11)
#define MOVE_COURT_CHANGE            (MOVES_COUNT_GEN7 + 12)
#define MOVE_DECORATE            (MOVES_COUNT_GEN7 + 13)
#define MOVE_DRAGON_DARTS            (MOVES_COUNT_GEN7 + 14)
#define MOVE_DRUM_BEATING            (MOVES_COUNT_GEN7 + 15)
#define MOVE_DUAL_WINGBEAT            (MOVES_COUNT_GEN7 + 16)
#define MOVE_DYNAMAX_CANNON            (MOVES_COUNT_GEN7 + 17)
#define MOVE_ETERNABEAM            (MOVES_COUNT_GEN7 + 18)
#define MOVE_EXPANDING_FORCE            (MOVES_COUNT_GEN7 + 19)
#define MOVE_FALSE_SURRENDER            (MOVES_COUNT_GEN7 + 20)
#define MOVE_FISHIOUS_REND            (MOVES_COUNT_GEN7 + 21)
#define MOVE_FLIP_TURN            (MOVES_COUNT_GEN7 + 22)
#define MOVE_G_MAX_BEFUDDLE            (MOVES_COUNT_GEN7 + 23)
#define MOVE_G_MAX_CANNONADE            (MOVES_COUNT_GEN7 + 24)
#define MOVE_G_MAX_CENTIFERNO            (MOVES_COUNT_GEN7 + 25)
#define MOVE_G_MAX_CHI_STRIKE            (MOVES_COUNT_GEN7 + 26)
#define MOVE_G_MAX_CUDDLE            (MOVES_COUNT_GEN7 + 27)
#define MOVE_G_MAX_DEPLETION            (MOVES_COUNT_GEN7 + 28)
#define MOVE_G_MAX_DRUM_SOLO            (MOVES_COUNT_GEN7 + 29)
#define MOVE_G_MAX_FINALE            (MOVES_COUNT_GEN7 + 30)
#define MOVE_G_MAX_FIREBALL            (MOVES_COUNT_GEN7 + 31)
#define MOVE_G_MAX_FOAM_BURST            (MOVES_COUNT_GEN7 + 32)
#define MOVE_G_MAX_GOLD_RUSH            (MOVES_COUNT_GEN7 + 33)
#define MOVE_G_MAX_GRAVITAS            (MOVES_COUNT_GEN7 + 34)
#define MOVE_G_MAX_HYDROSNIPE            (MOVES_COUNT_GEN7 + 35)
#define MOVE_G_MAX_MALODOR            (MOVES_COUNT_GEN7 + 36)
#define MOVE_G_MAX_MELTDOWN            (MOVES_COUNT_GEN7 + 37)
#define MOVE_G_MAX_ONE_BLOW            (MOVES_COUNT_GEN7 + 38)
#define MOVE_G_MAX_RAPID_FLOW            (MOVES_COUNT_GEN7 + 39)
#define MOVE_G_MAX_REPLENISH            (MOVES_COUNT_GEN7 + 40)
#define MOVE_G_MAX_RESONANCE            (MOVES_COUNT_GEN7 + 41)
#define MOVE_G_MAX_SANDBLAST            (MOVES_COUNT_GEN7 + 42)
#define MOVE_G_MAX_SMITE            (MOVES_COUNT_GEN7 + 43)
#define MOVE_G_MAX_SNOOZE            (MOVES_COUNT_GEN7 + 44)
#define MOVE_G_MAX_STEELSURGE            (MOVES_COUNT_GEN7 + 45)
#define MOVE_G_MAX_STONESURGE            (MOVES_COUNT_GEN7 + 46)
#define MOVE_G_MAX_STUN_SHOCK            (MOVES_COUNT_GEN7 + 47)
#define MOVE_G_MAX_SWEETNESS            (MOVES_COUNT_GEN7 + 48)
#define MOVE_G_MAX_TARTNESS            (MOVES_COUNT_GEN7 + 49)
#define MOVE_G_MAX_TERROR            (MOVES_COUNT_GEN7 + 50)
#define MOVE_G_MAX_VINE_LASH            (MOVES_COUNT_GEN7 + 51)
#define MOVE_G_MAX_VOLCALITH            (MOVES_COUNT_GEN7 + 52)
#define MOVE_G_MAX_VOLT_CRASH            (MOVES_COUNT_GEN7 + 53)
#define MOVE_G_MAX_WILDFIRE            (MOVES_COUNT_GEN7 + 54)
#define MOVE_G_MAX_WIND_RAGE            (MOVES_COUNT_GEN7 + 55)
#define MOVE_GRASSY_GLIDE            (MOVES_COUNT_GEN7 + 56)
#define MOVE_GRAV_APPLE            (MOVES_COUNT_GEN7 + 57)
#define MOVE_JAW_LOCK            (MOVES_COUNT_GEN7 + 58)
#define MOVE_JUNGLE_HEALING            (MOVES_COUNT_GEN7 + 59)
#define MOVE_LASH_OUT            (MOVES_COUNT_GEN7 + 60)
#define MOVE_LIFE_DEW            (MOVES_COUNT_GEN7 + 61)
#define MOVE_MAGIC_POWDER            (MOVES_COUNT_GEN7 + 62)
#define MOVE_MAX_AIRSTREAM            (MOVES_COUNT_GEN7 + 63)
#define MOVE_MAX_DARKNESS            (MOVES_COUNT_GEN7 + 64)
#define MOVE_MAX_FLARE            (MOVES_COUNT_GEN7 + 65)
#define MOVE_MAX_FLUTTERBY            (MOVES_COUNT_GEN7 + 66)
#define MOVE_MAX_GEYSER            (MOVES_COUNT_GEN7 + 67)
#define MOVE_MAX_GUARD            (MOVES_COUNT_GEN7 + 68)
#define MOVE_MAX_HAILSTORM            (MOVES_COUNT_GEN7 + 69)
#define MOVE_MAX_KNUCKLE            (MOVES_COUNT_GEN7 + 70)
#define MOVE_MAX_LIGHTNING            (MOVES_COUNT_GEN7 + 71)
#define MOVE_MAX_MINDSTORM            (MOVES_COUNT_GEN7 + 72)
#define MOVE_MAX_OOZE            (MOVES_COUNT_GEN7 + 73)
#define MOVE_MAX_OVERGROWTH            (MOVES_COUNT_GEN7 + 74)
#define MOVE_MAX_PHANTASM            (MOVES_COUNT_GEN7 + 75)
#define MOVE_MAX_QUAKE            (MOVES_COUNT_GEN7 + 76)
#define MOVE_MAX_ROCKFALL            (MOVES_COUNT_GEN7 + 77)
#define MOVE_MAX_STARFALL            (MOVES_COUNT_GEN7 + 78)
#define MOVE_MAX_STEELSPIKE            (MOVES_COUNT_GEN7 + 79)
#define MOVE_MAX_STRIKE            (MOVES_COUNT_GEN7 + 80)
#define MOVE_MAX_WYRMWIND            (MOVES_COUNT_GEN7 + 81)
#define MOVE_METEOR_ASSAULT            (MOVES_COUNT_GEN7 + 82)
#define MOVE_METEOR_BEAM            (MOVES_COUNT_GEN7 + 83)
#define MOVE_MISTY_EXPLOSION            (MOVES_COUNT_GEN7 + 84)
#define MOVE_NO_RETREAT            (MOVES_COUNT_GEN7 + 85)
#define MOVE_OBSTRUCT            (MOVES_COUNT_GEN7 + 86)
#define MOVE_OCTOLOCK            (MOVES_COUNT_GEN7 + 87)
#define MOVE_OVERDRIVE            (MOVES_COUNT_GEN7 + 88)
#define MOVE_POLTERGEIST            (MOVES_COUNT_GEN7 + 89)
#define MOVE_PYRO_BALL            (MOVES_COUNT_GEN7 + 90)
#define MOVE_RISING_VOLTAGE            (MOVES_COUNT_GEN7 + 91)
#define MOVE_SCALE_SHOT            (MOVES_COUNT_GEN7 + 92)
#define MOVE_SCORCHING_SANDS            (MOVES_COUNT_GEN7 + 93)
#define MOVE_SHELL_SIDE_ARM            (MOVES_COUNT_GEN7 + 94)
#define MOVE_SKITTER_SMACK            (MOVES_COUNT_GEN7 + 95)
#define MOVE_SNAP_TRAP            (MOVES_COUNT_GEN7 + 96)
#define MOVE_SNIPE_SHOT            (MOVES_COUNT_GEN7 + 97)
#define MOVE_SPIRIT_BREAK            (MOVES_COUNT_GEN7 + 98)
#define MOVE_STEEL_BEAM            (MOVES_COUNT_GEN7 + 99)
#define MOVE_STEEL_ROLLER            (MOVES_COUNT_GEN7 + 100)
#define MOVE_STRANGE_STEAM            (MOVES_COUNT_GEN7 + 101)
#define MOVE_STUFF_CHEEKS            (MOVES_COUNT_GEN7 + 102)
#define MOVE_SURGING_STRIKES            (MOVES_COUNT_GEN7 + 103)
#define MOVE_TAR_SHOT            (MOVES_COUNT_GEN7 + 104)
#define MOVE_TEATIME            (MOVES_COUNT_GEN7 + 105)
#define MOVE_TERRAIN_PULSE            (MOVES_COUNT_GEN7 + 106)
#define MOVE_TRIPLE_AXEL            (MOVES_COUNT_GEN7 + 107)
#define MOVE_WICKED_BLOW            (MOVES_COUNT_GEN7 + 108)


#define MOVES_COUNT_GEN8            (MOVES_COUNT_GEN7 + 109)
