...
{
    ABILITY_EFFECT_NONE,
    ABILITY_EFFECT_ADDS_MOVE_EFFECT,
    ABILITY_EFFECT_SUMMONS_WEATHER,
    ABILITY_EFFECT_RAISES_STAT_STAGE,
    ABILITY_EFFECT_PREVENTS_CRITICAL_HITS,
    ABILITY_EFFECT_PREVENTS_OHKO,
    ABILITY_EFFECT_DAMP,
    ABILITY_EFFECT_PREVENTS_STATUS1,
    ABILITY_EFFECT_PREVENTS_STATUS2,
    ABILITY_EFFECT_BOOSTS_STAT,
    ABILITY_EFFECT_MOVE_EFFECT_ON_CONTACT,
    ABILITY_EFFECT_IMMUNITY_TO_TYPE,
    ABILITY_EFFECT_REDIRECT_TYPE,
    ABILITY_EFFECT_OBLIVIOUS,
    ABILITY_EFFECT_AIR_LOCK,
    ABILITY_EFFECT_COLOR_CHANGE,
    ABILITY_EFFECT_PREVENTS_SECONDARY_EFFECTS,
    ABILITY_EFFECT_PREVENTS_PHAZING,
    ABILITY_EFFECT_INTIMIDATE,
    ABILITY_EFFECT_TRAPS_OPPONENTS,
    ABILITY_EFFECT_ROUGH_SKIN,
    ABILITY_EFFECT_WONDER_GUARD,
    ABILITY_EFFECT_LEVITATE,
    ABILITY_EFFECT_SYNCHRONIZE,
    ABILITY_EFFECT_PREVENTS_STAT_DROPS,
    ABILITY_EFFECT_NATURAL_CURE,
    ABILITY_EFFECT_SERENE_GRACE,
    ABILITY_EFFECT_TRACE,
    ABILITY_EFFECT_SOUNDPROOF,
    ABILITY_EFFECT_UPDATE_HP_IN_WEATHER,
    ABILITY_EFFECT_PRESSURE,
    ABILITY_EFFECT_THICK_FAT,
    ABILITY_EFFECT_EARLY_BIRD,
    ABILITY_EFFECT_RUN_AWAY,
    ABILITY_EFFECT_PICKUP,
    ABILITY_EFFECT_TRUANT,
    ABILITY_EFFECT_HUSTLE,
    ABILITY_EFFECT_PLUS_MINUS,
    ABILITY_EFFECT_FORECAST,
    ABILITY_EFFECT_STICKY_HOLD,
    ABILITY_EFFECT_SHED_SKIN,
    ABILITY_EFFECT_LIQUID_OOZE,
    ABILITY_EFFECT_BOOST_MOVE_POWER,
    ABILITY_EFFECT_ROCK_HEAD,
};

enum AbilityBoostStatCondition
{
    // The below apply flat stat boosts
    ABILITY_BOOST_STAT_ALWAYS,
    ABILITY_BOOST_STAT_ON_WEATHER,
    ABILITY_BOOST_STAT_ON_TERRAIN,
    ABILITY_BOOST_STAT_ON_STATUS1,
    ABILITY_BOOST_STAT_ON_STATUS2,

    // The below apply stat !!stage!! boosts
    ABILITY_BOOST_STAT_STAGE_ON_TURN_END,
};

enum AbilityBoostMoveCondition
{
    ABILITY_BOOST_MOVE_UNCONDITIONALLY,
    ABILITY_BOOST_MOVE_IF_PHYSICAL,
    ABILITY_BOOST_MOVE_IF_SPECIAL,
    ABILITY_BOOST_MOVE_IF_SUPER_EFFECTIVE,
    ABILITY_BOOST_MOVE_IF_NOT_VERY_EFFECTIVE,
    ABILITY_BOOST_MOVE_IF_BELOW_HP_PERCENTAGE,
};

enum AbilityEncounterRateModifier
{
    ABILITY_ENCOUNTER_RATE_UNMODIFIED,
    ABILITY_ENCOUNTER_RATE_DOUBLED,
    ABILITY_ENCOUNTER_RATE_HALVED,
    ABILITY_ENCOUNTER_RATE_HALVED_IN_WEATHER,
};

enum AbilityImmunityEffect
{
    ABILITY_IMMUNITY_NONE,
    ABILITY_IMMUNITY_ABSORPTION,
    ABILITY_IMMUNITY_STAT_BOOST,
    ABILITY_IMMUNITY_FLASH_FIRE,
};

enum AbilityTrapRequirement
{
    ABILITY_TRAPS_ANY,
    ABILITY_TRAPS_GROUNDED,
    ABILITY_TRAPS_TYPE,
};
