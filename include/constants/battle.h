...
#define BATTLE_TYPE_2_VS_1_5           (1 << 11) // Necrite - vs Rayquaza and Deoxys
#define BATTLE_TYPE_NECROZMA           (1 << 12) // Necrite - Necrozma SOS battle
...
#define BATTLE_TYPE_LEAGUE (1 << 31)
