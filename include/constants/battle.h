...
#define WEATHER_RAIN_PRIMORDIAL     (1 << 1)  // unused
#define WEATHER_RAIN_PERMANENT      (1 << 2)
#define WEATHER_RAIN_ANY            (WEATHER_RAIN_TEMPORARY | WEATHER_RAIN_PRIMORDIAL | WEATHER_RAIN_PERMANENT)
...
#define WEATHER_SUN_ANY             (WEATHER_SUN_TEMPORARY | WEATHER_SUN_DESOLATE | WEATHER_SUN_PERMANENT)
