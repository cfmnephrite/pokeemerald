...
// NEW Volatile statuses
#define V_COUNT(int) ((1 << ((int % 13) + 3)) + (int / 13))

#define VOLATILE_STATUS_CONFUSION           V_COUNT(1)
#define VOLATILE_STATUS_FLINCHED            V_COUNT(2)
#define VOLATILE_STATUS_UPROAR              V_COUNT(3)
#define VOLATILE_STATUS_TORMENT             V_COUNT(4)
#define VOLATILE_STATUS_BIDE                V_COUNT(5)
#define VOLATILE_STATUS_LOCK_CONFUSE        V_COUNT(6)
#define VOLATILE_STATUS_MULTIPLETURNS       V_COUNT(7)
#define VOLATILE_STATUS_WRAPPED             V_COUNT(8)
#define VOLATILE_STATUS_POWDER              V_COUNT(9)
#define VOLATILE_STATUS_INFATUATION         V_COUNT(10)
#define VOLATILE_STATUS_DEFENSE_CURL        V_COUNT(11)
#define VOLATILE_STATUS_TRANSFORMED         V_COUNT(12)
#define VOLATILE_STATUS_RECHARGE            V_COUNT(13)
#define VOLATILE_STATUS_RAGE                V_COUNT(14)
#define VOLATILE_STATUS_SUBSTITUTE          V_COUNT(15)
#define VOLATILE_STATUS_DESTINY_BOND        V_COUNT(16)
#define VOLATILE_STATUS_ESCAPE_PREVENTION   V_COUNT(17)
#define VOLATILE_STATUS_NIGHTMARE           V_COUNT(18)
#define VOLATILE_STATUS_CURSED              V_COUNT(19)
#define VOLATILE_STATUS_FORESIGHT           V_COUNT(20)
#define VOLATILE_STATUS_DRAGON_CHEER        V_COUNT(21)
#define VOLATILE_STATUS_FOCUS_ENERGY        V_COUNT(22)
#define VOLATILE_STATUS_LEECHSEED           V_COUNT(23)
#define VOLATILE_STATUS_ALWAYS_HITS         V_COUNT(24)
#define VOLATILE_STATUS_PERISH_SONG         V_COUNT(25)
#define VOLATILE_STATUS_ON_AIR              V_COUNT(26)
#define VOLATILE_STATUS_UNDERGROUND         V_COUNT(27)
#define VOLATILE_STATUS_MINIMIZED           V_COUNT(28)
#define VOLATILE_STATUS_CHARGED_UP          V_COUNT(29)
#define VOLATILE_STATUS_ROOTED              V_COUNT(30)
#define VOLATILE_STATUS_YAWN                V_COUNT(31)
// #define STATUS2_FOCUS_ENERGY_ANY      (STATUS2_DRAGON_CHEER | STATUS2_FOCUS_ENERGY)
