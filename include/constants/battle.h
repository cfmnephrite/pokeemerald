...
#define WEATHER_SANDSTORM_SEMI_PERMANENT  (1 << 10)
#define WEATHER_HAIL_TEMPORARY            (1 << 11)
#define WEATHER_HAIL_OVERWORLD            (1 << 12)
#define WEATHER_HAIL_SEMI_PERMANENT       (1 << 13)
#define WEATHER_HAIL_FORECAST             (1 << 14)
#define WEATHER_DELTA_STREAM              (1 << 15)
