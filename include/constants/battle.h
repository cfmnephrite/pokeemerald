...
#define WEATHER_RAIN_TEMPORARY            0x1
#define WEATHER_RAIN_OVERWORLD            0x2
#define WEATHER_RAIN_PRIMORDIAL           0x4
#define WEATHER_RAIN_FORECAST             0x8
#define WEATHER_SUN_TEMPORARY             0x10
#define WEATHER_SUN_OVERWORLD             0x20
#define WEATHER_SUN_DESOLATE              0x40
#define WEATHER_SUN_FORECAST              0x80
#define WEATHER_SANDSTORM_TEMPORARY       0x100
#define WEATHER_SANDSTORM_OVERWORLD       0x200
#define WEATHER_SANDSTORM_SEMI_PERMANENT  0x400
#define WEATHER_HAIL_TEMPORARY            0x800
#define WEATHER_HAIL_OVERWORLD            0x1000
#define WEATHER_HAIL_SEMI_PERMANENT       0x2000
#define WEATHER_HAIL_FORECAST             0x4000
#define WEATHER_DELTA_STREAM              0x8000
...
#define WEATHER_SANDSTORM_ANY             (WEATHER_SANDSTORM_TEMPORARY | WEATHER_SANDSTORM_OVERWORLD | WEATHER_SANDSTORM_SEMI_PERMANENT)
#define WEATHER_HAIL_ANY                  (WEATHER_HAIL_TEMPORARY | WEATHER_HAIL_OVERWORLD | WEATHER_HAIL_SEMI_PERMANENT | WEATHER_HAIL_FORECAST)
