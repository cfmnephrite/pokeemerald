...
#define WEATHER_RAIN_PRIMORDIAL     (1 << 1)
#define WEATHER_RAIN_PERMANENT      (1 << 2)
#define WEATHER_RAIN_FORECAST		(1 << 3)
#define WEATHER_RAIN_ANY            (WEATHER_RAIN_TEMPORARY | WEATHER_RAIN_PRIMORDIAL | WEATHER_RAIN_PERMANENT | WEATHER_RAIN_FORECAST)
...
#define WEATHER_SUN_DESOLATE        (1 << 7)
#define WEATHER_SUN_PERMANENT       (1 << 8)
#define WEATHER_SUN_FORECAST		(1 << 9)
#define WEATHER_SUN_ANY             (WEATHER_SUN_TEMPORARY | WEATHER_SUN_DESOLATE | WEATHER_SUN_PERMANENT | WEATHER_SUN_FORECAST)
#define WEATHER_HAIL_TEMPORARY      (1 << 10)
#define WEATHER_HAIL_PERMANENT      (1 << 11)
#define WEATHER_HAIL_FORECAST		(1 << 12)
#define WEATHER_HAIL_ANY            (WEATHER_HAIL_TEMPORARY | WEATHER_HAIL_PERMANENT | WEATHER_HAIL_FORECAST)
