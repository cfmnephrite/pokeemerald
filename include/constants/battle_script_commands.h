...
#define STAT_BUFF_ATK_SPA_2         (STAT_BUFF_ATK_2 | STAT_BUFF_SPA_2)
#define STAT_BUFF_DEF_SPD_1         (STAT_BUFF_DEF_1 | STAT_BUFF_SPD_1)
#define STAT_BUFF_ATK_DEF_ACC_1     (STAT_BUFF_ATK_1 | STAT_BUFF_DEF_1 | STAT_BUFF_ACC_1)
#define STAT_BUFF_ATK_SPA_SPE_1     (STAT_BUFF_ATK_1 | STAT_BUFF_SPA_1 | STAT_BUFF_SPE_1)
#define STAT_BUFF_ATK_SPA_SPE_2     (STAT_BUFF_ATK_2 | STAT_BUFF_SPA_2 | STAT_BUFF_SPE_2)
