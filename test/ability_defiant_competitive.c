...
SINGLE_BATTLE_TEST("Status moves activate Defiant")
{
    PARAMETRIZE {}
    GIVEN {
...
SINGLE_BATTLE_TEST("Status moves activate Competitive")
{
    PARAMETRIZE {}
    GIVEN {
...
SINGLE_BATTLE_TEST("Multiple stat drop status moves activate Defiant multiple times")
{
    PARAMETRIZE {}
    GIVEN {
...
SINGLE_BATTLE_TEST("Multiple stat drop status moves activate Competitive multiple times")
{
    PARAMETRIZE {}
    GIVEN {
...
SINGLE_BATTLE_TEST("Attacking moves activate Defiant")
{
    PARAMETRIZE {}
    GIVEN {
...
SINGLE_BATTLE_TEST("Self-stat-dropping moves don't trigger Defiant")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Self-stat-dropping moves don't trigger Competitive")
{
    GIVEN {
        ASSUME(gBattleMoves[MOVE_HAMMER_ARM].effect == EFFECT_HAMMER_ARM);
        ASSUME(gBattleMoves[MOVE_OVERHEAT].effect == EFFECT_OVERHEAT);
