    ...
    case 0:
        ...
        switch (subStruct->glyphId)
        {
            ...
            case 5:
            {
                ...
                gUnknown_03002F90.width = func(currChar, textPrinter->japanese);
                gUnknown_03002F90.height = gFontInfos[subStruct->glyphId].maxLetterHeight;
