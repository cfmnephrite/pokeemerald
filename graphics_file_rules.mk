...
types := mystery bug dark dragon electric fairy fight fire flying ghost grass ground ice normal poison psychic rock steel water 
...
$(FONTGFXDIR)/hpboxfont.4bpp: $(FONTGFXDIR)/hpboxfont.png
	$(GFX) $< $@
