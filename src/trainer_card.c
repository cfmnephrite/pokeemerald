...
static void SetPlayerCardData(struct TrainerCard *trainerCard, u8 cardType)
{
    ...
    for (i = 0; i < 4; i++)
        trainerCard->var_28[i] = gSaveBlockPtr->easyChatProfile[i];
...
static void TrainerCard_GenerateCardForLinkPlayer(struct TrainerCard *trainerCard)
{
    ...
    trainerCard->frontierBP = gSaveBlockPtr->frontier.field_EBA;
...
void TrainerCard_GenerateCardForPlayer(struct TrainerCard *trainerCard)
{
    ...
    *((u16*)&trainerCard->berryCrushPoints) = gSaveBlockPtr->frontier.field_EBA;
...
static void sub_80C4EE4(void)
{
    ...
    sData->var_0 = 0;
    sData->var_6 = gSaveBlockPtr->playTimeVBlanks;
    sData->var_7 = 0;
    sData->var_8 = 0;
    sData->var_528 = 0;
