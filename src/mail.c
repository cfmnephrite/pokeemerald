...
static bool8 MailReadBuildGraphics(void)
{
    ...
    switch (gMain.state)
    {
        ...
        case 12:
            ...
            gPlttBufferUnfaded[10] = sUnknown_0859F2B0[gSaveBlockPtr->playerGender][0];
            gPlttBufferFaded[10] = sUnknown_0859F2B0[gSaveBlockPtr->playerGender][0];
            gPlttBufferUnfaded[11] = sUnknown_0859F2B0[gSaveBlockPtr->playerGender][1];
            gPlttBufferFaded[11] = sUnknown_0859F2B0[gSaveBlockPtr->playerGender][1];
            break;
        case 13:
            if (sMailRead->flag)
            {
