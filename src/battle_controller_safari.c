...
static void SafariHandleDrawTrainerPic(void)
{
    DecompressTrainerBackPic(gSaveBlockPtr->playerGender, gActiveBattler);
    SetMultiuseSpriteTemplateToTrainerBack(gSaveBlockPtr->playerGender, GetBattlerPosition(gActiveBattler));
    gBattlerSpriteIds[gActiveBattler] = CreateSprite(
      &gMultiuseSpriteTemplate,
      80,
      (8 - gTrainerBackPicCoords[gSaveBlockPtr->playerGender].size) * 4 + 80,
      30);
