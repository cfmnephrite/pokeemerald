...
const u8 gText_SideWithAqua[] = _("Side with Aqua"); 
const u8 gText_SideWithMagma[] = _("Side with Magma");
const u8 gText_Leave[] = _("Leave");
const u8 gText_TheGymSystem[] = _("The Gym System"); 
const u8 gText_TheNormalType[] = _("The Normal Type");
const u8 gText_NothingForNow[] = _("Nothing for now");
...
const u8 gText_RedFemaleSymbol[] = _("{FEMALE_S}");
const u8 gText_BlueMaleSymbol[] = _("{MALE_S}");
