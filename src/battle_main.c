...
EWRAM_DATA u8 gSwitchedIn[MAX_BATTLERS_COUNT] = {0};
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            switch (gTrainers[trainerNum].partyFlags)
            {
                ...
                case F_TRAINER_PARTY_COMPETITIVE_CUSTOM_IVS:
                {
                    const struct TrainerMonCustomMovesItemEVsIVs *partyData = gTrainers[trainerNum].party.ItemCustomMovesEVsIVs;
...
void SetTypeAndSplitBeforeUsingMove(u16 move, u8 battlerAtk)
{
    ...
    if (gBattleMoves[move].split != GetBattleMoveSplit(battlerAtk, move))
    {
