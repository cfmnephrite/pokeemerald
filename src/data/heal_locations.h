static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 7, 21},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 8, 21},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 15, 28},
    ...
    [HEAL_LOCATION_RUSTBOROUGH_SOUTH - 1] = {MAP_GROUP(RUSTBOROUGH_SOUTH), MAP_NUM(RUSTBOROUGH_SOUTH), 4, 10},
    [HEAL_LOCATION_RUSTBOROUGH_CENTRAL_WEST - 1] = {MAP_GROUP(RUSTBOROUGH_CENTRAL_WEST), MAP_NUM(RUSTBOROUGH_CENTRAL_WEST), 0, 0},
    [HEAL_LOCATION_RUSTBOROUGH_CENTRAL_EAST - 1] = {MAP_GROUP(RUSTBOROUGH_CENTRAL_EAST), MAP_NUM(RUSTBOROUGH_CENTRAL_EAST), 0, 0},
    [HEAL_LOCATION_RUSTBOROUGH_NORTH_WEST - 1] = {MAP_GROUP(RUSTBOROUGH_NORTH_WEST), MAP_NUM(RUSTBOROUGH_NORTH_WEST), 0, 0},
    [HEAL_LOCATION_RUSTBOROUGH_NORTH_EAST - 1] = {MAP_GROUP(RUSTBOROUGH_NORTH_EAST), MAP_NUM(RUSTBOROUGH_NORTH_EAST), 0, 0},
};
