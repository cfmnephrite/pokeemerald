static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SOUTH_RUSTBOROUGH - 1] = {MAP_GROUP(SOUTH_RUSTBOROUGH), MAP_NUM(SOUTH_RUSTBOROUGH), 0, 0},
    [HEAL_LOCATION_CENTRAL_WEST_RUSTBOROUGH - 1] = {MAP_GROUP(CENTRAL_WEST_RUSTBOROUGH), MAP_NUM(CENTRAL_WEST_RUSTBOROUGH), 0, 0},
    [HEAL_LOCATION_CENTRAL_EAST_RUSTBOROUGH - 1] = {MAP_GROUP(CENTRAL_EAST_RUSTBOROUGH), MAP_NUM(CENTRAL_EAST_RUSTBOROUGH), 0, 0},
    [HEAL_LOCATION_NORTH_WEST_RUSTBOROUGH - 1] = {MAP_GROUP(NORTH_WEST_RUSTBOROUGH), MAP_NUM(NORTH_WEST_RUSTBOROUGH), 0, 0},
    [HEAL_LOCATION_NORTH_EAST_RUSTBOROUGH - 1] = {MAP_GROUP(NORTH_EAST_RUSTBOROUGH), MAP_NUM(NORTH_EAST_RUSTBOROUGH), 0, 0},
};
