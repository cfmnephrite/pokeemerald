...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_ALL_OUT_PUMMELING - 1] = sNotDoneYetDescription,
    ...
    [MOVE_HIDDEN_POWER_DRAGON - 1] = sHiddenPowerDescription,
    [MOVE_HIDDEN_POWER_ELECTRIC - 1] = sHiddenPowerDescription,
    [MOVE_HIDDEN_POWER_FAIRY - 1] = sHiddenPowerDescription,
    ...
    [MOVE_HIDDEN_POWER_POISON - 1] = sHiddenPowerDescription,
    [MOVE_HIDDEN_POWER_ROCK - 1] = sHiddenPowerDescription,
    [MOVE_HIDDEN_POWER_STEEL - 1] = sHiddenPowerDescription,
