...
static const u8 sIntrepidSwordDescription[] = _("Boosts Attack on switch-in.");
static const u8 sDauntlessShieldDescription[] = _("Boosts Defense on switch-in.");
static const u8 sLiberoDescription[] = _("Changes type to used move.");
static const u8 sBallFetchDescription[] = _("Picks up missed Pokéballs.");
static const u8 sCottonDownDescription[] = _("Slows all Pokémon when hit.");
static const u8 sPropellerTailDescription[] = _("Ignores redirection effects.");
static const u8 sMirrorArmorDescription[] = _("Bounces back stat drops.");
static const u8 sGulpMissileDescription[] = _("Catch prey; spit when hit.");
static const u8 sStalwartDescription[] = _("Ignores redirection effects.");
static const u8 sSteamEngineDescription[] = _("Maxes speed on water or fire.");
static const u8 sPunkRockDescription[] = _("Powers up sound moves.");
static const u8 sSandSpitDescription[] = _("Summons sandstorm when hit.");
static const u8 sIceScalesDescription[] = _("Raises Special Defense.");
static const u8 sRipenDescription[] = _("Boosts berry effectiveness.");
static const u8 sIceFaceDescription[] = _("Head takes 1 physical hit.");
static const u8 sPowerSpotDescription[] = _("Boosts ally's moves.");
static const u8 sMimicryDescription[] = _("Changes type to match terrain.");
static const u8 sScreenCleanerDescription[] = _("Removes screens.");
static const u8 sSteelySpiritDescription[] = _("Powers up Steel moves.");
static const u8 sPerishBodyDescription[] = _("Contact causes Perish Song.");
static const u8 sWanderingSpiritDescription[] = _("Swaps abilities on contact.");
static const u8 sGorillaTacticsDescription[] = _("Boosts Atk; only use 1 move.");
static const u8 sNeutralizingGasDescription[] = _("Nullifies abilities.");
static const u8 sPastelVeilDescription[] = _("Prevents poisoning.");
static const u8 sHungerSwitchDescription[] = _("Switches forms every turn.");
static const u8 sQuickDrawDescription[] = _("Sometimes goes first.");
static const u8 sUnseenFistDescription[] = _("Ignores protection.");
...
const u8 gAbilityNames[ABILITIES_COUNT_GEN8][ABILITY_NAME_LENGTH + 1] =
{
	...
	[ABILITY_INTREPID_SWORD] = _("Intrep Sword"),
	[ABILITY_DAUNTLESS_SHIELD] = _("Daunt Shield"),
	[ABILITY_LIBERO] = _("Libero"),
	[ABILITY_BALL_FETCH] = _("Ball Fetch"),
	[ABILITY_COTTON_DOWN] = _("Cotton Down"),
	[ABILITY_PROPELLER_TAIL] = _("Propel Tail"),
	...
	[ABILITY_GORILLA_TACTICS] = _("GorillaTacts"),
	[ABILITY_NEUTRALIZING_GAS] = _("NeutralizGas"),
