const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_BREAKNECK_BLITZ] = _("Not In Yet"),
    [MOVE_Z_NORMAL_2] = _("Not In Yet"),
    [MOVE_ALL_OUT_PUMELLING] = _("Not In Yet"),
    [MOVE_HP_FIGHTING] = _("Hidden Power"),
    [MOVE_SUPERSONIC_SKYSTRIKE] = _("Not In Yet"),
    [MOVE_HP_FLYING_2] = _("Hidden Power"),
    [MOVE_ACID_DOWNPOUR] = _("Not In Yet"),
    [MOVE_HP_POISON] = _("Hidden Power"),
    [MOVE_TECTONIC_RAGE] = _("Not In Yet"),
    [MOVE_HP_GROUND] = _("Hidden Power"),
    [MOVE_CONTINENTAL_CRUSH] = _("Not In Yet"),
    [MOVE_HP_ROCK] = _("Hidden Power"),
    [MOVE_SAVAGE_SPIN_OUT] = _("Not In Yet"),
    [MOVE_HP_BUG] = _("Hidden Power"),
    [MOVE_NEVER_ENDING_NIGHTMARE] = _("Not In Yet"),
    [MOVE_HP_GHOST] = _("Hidden Power"),
    [MOVE_CORKSCREW_CRASH] = _("Not In Yet"),
    [MOVE_HP_STEEL] = _("Hidden Power"),
    [MOVE_INFERNO_OVERDRIVE] = _("Not In Yet"),
    [MOVE_HP_FIRE] = _("Hidden Power"),
    [MOVE_HYDRO_VORTEX] = _("Not In Yet"),
    [MOVE_HP_WATER] = _("Hidden Power"),
    [MOVE_BLOOM_DOOM] = _("Not In Yet"),
    [MOVE_HP_GRASS] = _("Hidden Power"),
    [MOVE_GIGAVOLT_HAVOC] = _("Not In Yet"),
    [MOVE_HP_ELECTRIC] = _("Hidden Power"),
    [MOVE_SHATTERED_PSYCHE] = _("Not In Yet"),
    [MOVE_Z_PSYCHIC_2] = _("Not In Yet"),
    [MOVE_SUBZERO_SLAMMER] = _("Not In Yet"),
    [MOVE_HP_ICE] = _("Hidden Power"),
    [MOVE_DEVASTATING_DRAKE] = _("Not In Yet"),
    [MOVE_HP_DRAGON] = _("Hidden Power"),
    [MOVE_BLACK_HOLE_ECLIPSE] = _("Not In Yet"),
    [MOVE_HP_DARK] = _("Hidden Power"),
    [MOVE_TWINKLE_TACKLE] = _("Not In Yet"),
    ...
    [MOVE_SINISTER_ARROW_RAID] = _("Not In Yet"),
    [MOVE_MALICIOUS_MOONSAULT] = _("Not In Yet"),
    [MOVE_OCEANIC_OPERETTA] = _("Not In Yet"),
    [MOVE_GUARDIAN_OF_ALOLA] = _("Not In Yet"),
    [MOVE_SOUL_STEALING_7_STAR_STRIKE] = _("Not In Yet"),
    [MOVE_STOKED_SPARKSURFER] = _("Not In Yet"),
    [MOVE_PULVERISING_PANCAKE] = _("Not In Yet"),
    [MOVE_EXTREME_EVOBOOST] = _("Not In Yet"),
    [MOVE_GENESIS_SUPERNOVA] = _("Not In Yet"), 
    ...
    [MOVE_MIND_BLOWN] = _("Not In Yet"),
    [MOVE_PLASMA_FISTS] = _("Not In Yet"),
    [MOVE_PHOTON_GEYSER] = _("Not In Yet"),
    [MOVE_LIGHT_THAT_BURNS_THE_SKY] = _("Not In Yet"),
    [MOVE_SEARING_SUNRAZE_SMASH] = _("Not In Yet"),
    [MOVE_MENACING_MOONRAZE_MAELSTROM] = _("Not In Yet"),
    [MOVE_LET_S_SNUGGLE_FOREVER] = _("Not In Yet"),
    [MOVE_SPLINTERED_STORMSHARDS] = _("Not In Yet"),
    [MOVE_CLANGOROUS_SOULBLAZE] = _("Not In Yet"),
    ...
    [MOVE_DOUBLE_IRON_BASH] = _("Not In Yet"),
};
