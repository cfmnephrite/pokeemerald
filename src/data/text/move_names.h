const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_BEHEMOTH_BASH] = _("Behemoth Bas"),
    [MOVE_BEHEMOTH_BLADE] = _("Behemoth Bla"),
    [MOVE_BELCH] = _("Belch"),
    ...
    [MOVE_BREAKING_SWIPE] = _("Breaking Swi"),
    ...
    [MOVE_BURNING_JEALOUSY] = _("Burning Jeal"),
    ...
    [MOVE_CLANGOROUS_SOUL] = _("Clangorous S"),
    ...
    [MOVE_CORROSIVE_GAS] = _("Corrosive Ga"),
    ...
    [MOVE_DUAL_WINGBEAT] = _("Dual Wingbea"),
    [MOVE_DYNAMAX_CANNON] = _("Dynamax Cann"),
    ...
    [MOVE_EXPANDING_FORCE] = _("Expanding Fo"),
    ...
    [MOVE_FISHIOUS_REND] = _("Fishious Ren"),
    ...
    [MOVE_G_MAX_BEFUDDLE] = _("G-Max Befudd"),
    [MOVE_G_MAX_CANNONADE] = _("G-Max Cannon"),
    [MOVE_G_MAX_CENTIFERNO] = _("G-Max Centif"),
    [MOVE_G_MAX_CHI_STRIKE] = _("G-Max Chi St"),
    [MOVE_G_MAX_CUDDLE] = _("G-Max Cuddle"),
    [MOVE_G_MAX_DEPLETION] = _("G-Max Deplet"),
    [MOVE_G_MAX_DRUM_SOLO] = _("G-Max Drum S"),
    [MOVE_G_MAX_FINALE] = _("G-Max Finale"),
    [MOVE_G_MAX_FIREBALL] = _("G-Max Fireba"),
    [MOVE_G_MAX_FOAM_BURST] = _("G-Max Foam B"),
    [MOVE_G_MAX_GOLD_RUSH] = _("G-Max Gold R"),
    [MOVE_G_MAX_GRAVITAS] = _("G-Max Gravit"),
    [MOVE_G_MAX_HYDROSNIPE] = _("G-Max Hydros"),
    [MOVE_G_MAX_MALODOR] = _("G-Max Malodo"),
    [MOVE_G_MAX_MELTDOWN] = _("G-Max Meltdo"),
    [MOVE_G_MAX_ONE_BLOW] = _("G-Max One Bl"),
    [MOVE_G_MAX_RAPID_FLOW] = _("G-Max Rapid "),
    [MOVE_G_MAX_REPLENISH] = _("G-Max Replen"),
    [MOVE_G_MAX_RESONANCE] = _("G-Max Resona"),
    [MOVE_G_MAX_SANDBLAST] = _("G-Max Sandbl"),
    [MOVE_G_MAX_SMITE] = _("G-Max Smite"),
    [MOVE_G_MAX_SNOOZE] = _("G-Max Snooze"),
    [MOVE_G_MAX_STEELSURGE] = _("G-Max Steels"),
    [MOVE_G_MAX_STONESURGE] = _("G-Max Stones"),
    [MOVE_G_MAX_STUN_SHOCK] = _("G-Max Stun S"),
    [MOVE_G_MAX_SWEETNESS] = _("G-Max Sweetn"),
    [MOVE_G_MAX_TARTNESS] = _("G-Max Tartne"),
    [MOVE_G_MAX_TERROR] = _("G-Max Terror"),
    [MOVE_G_MAX_VINE_LASH] = _("G-Max Vine L"),
    [MOVE_G_MAX_VOLCALITH] = _("G-Max Volcal"),
    [MOVE_G_MAX_VOLT_CRASH] = _("G-Max Volt C"),
    [MOVE_G_MAX_WILDFIRE] = _("G-Max Wildfi"),
    [MOVE_G_MAX_WIND_RAGE] = _("G-Max Wind R"),
    ...
    [MOVE_JUNGLE_HEALING] = _("Jungle Heali"),
    ...
    [MOVE_LEER] = _("Leer"),
    [MOVE_LETS_SNUGGLE_FOREVER] = _("Snuggle"),
    [MOVE_LICK] = _("Lick"),
    ...
    [MOVE_MAX_AIRSTREAM] = _("Max Airstrea"),
    [MOVE_MAX_DARKNESS] = _("Max Darkness"),
    [MOVE_MAX_FLARE] = _("Max Flare"),
    [MOVE_MAX_FLUTTERBY] = _("Max Flutterb"),
    [MOVE_MAX_GEYSER] = _("Max Geyser"),
    [MOVE_MAX_GUARD] = _("Max Guard"),
    [MOVE_MAX_HAILSTORM] = _("Max Hailstor"),
    [MOVE_MAX_KNUCKLE] = _("Max Knuckle"),
    [MOVE_MAX_LIGHTNING] = _("Max Lightnin"),
    [MOVE_MAX_MINDSTORM] = _("Max Mindstor"),
    [MOVE_MAX_OOZE] = _("Max Ooze"),
    [MOVE_MAX_OVERGROWTH] = _("Max Overgrow"),
    ...
    [MOVE_MAX_STEELSPIKE] = _("Max Steelspi"),
    ...
    [MOVE_METEOR_ASSAULT] = _("Meteor Assau"),
    ...
    [MOVE_RISING_VOLTAGE] = _("Rising Volta"),
    [MOVE_ROAR] = _("Roar"),
    ...
    [MOVE_SCORCHING_SANDS] = _("Scorching Sa"),
    ...
    [MOVE_SHELL_SIDE_ARM] = _("Shell Side A"),
    ...
    [MOVE_SKITTER_SMACK] = _("Skitter Smac"),
    ...
    [MOVE_STRANGE_STEAM] = _("Strange Stea"),
    ...
    [MOVE_SURF] = _("Surf"),
    [MOVE_SURGING_STRIKES] = _("Surging Stri"),
    ...
    [MOVE_TERRAIN_PULSE] = _("Terrain Puls"),
    [MOVE_THIEF] = _("Thief"),
