...
static const u8 sText_PkmnWasParalysedBy[] = _("{B_EFF_NAME_WITH_PREFIX} was paralysed by\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1}!");
...
static const u8 sText_PkmnReturnedToType[] = _("{B_ATK_NAME_WITH_PREFIX} returned to its\noriginal type!");
...
const u8 * const gStatNamesTable[NUM_BATTLE_STATS + 1] =
{
...
static const u8 sText_PkmnsItemCuredParalysis[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured paralysis!");
static const u8 sText_PkmnsItemCuredPoison[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured poison!");
static const u8 sText_PkmnsItemHealedBurn[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nhealed its burn!");
static const u8 sText_PkmnsItemDefrostedIt[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ndefrosted it!");
static const u8 sText_PkmnsItemWokeIt[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nwoke it from its sleep!");
static const u8 sText_PkmnsItemSnappedOut[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nsnapped it out of confusion!");
static const u8 sText_PkmnsItemCuredProblem[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured its {B_BUFF1} problem!");
static const u8 sText_PkmnsItemNormalizedStatus[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nnormalized its status!");
static const u8 sText_PkmnsItemRestoredHealth[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored health!");
...
static const u8 sText_BelchCantUse[] = _("{B_CURRENT_MOVE} cannot be used!\p");
...
static const u8 sText_TargetAteItem[] = _("{B_DEF_NAME_WITH_PREFIX} ate its\n{B_LAST_ITEM}!");
...
static const u8 sText_CantEscapeBecauseOf[] = _("{B_DEF_NAME_WITH_PREFIX} can no longer escape\nbecause of {B_CURRENT_MOVE}!");
...
static const u8 sText_ScreenCleanerActivates[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} wiped\nall screens from the field!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNPREVENTSBURNWITH - 12] = sText_PkmnsXPreventsBurns,
    ...
    [STRINGID_CANTESCAPEBECAUSEOF - 12] = sText_CantEscapeBecauseOf,
    [STRINGID_NEUTRALIZINGGASENTERS - 12] = sText_NeutralizingGasActivates,
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [MULTI_SWITCHIN_NEUTRALIZINGGAS] = STRINGID_NEUTRALIZINGGASENTERS,
};
...
{
    [TWO_TURN_FLY] = STRINGID_PKMNFLEWHIGH,
    [TWO_TURN_DIVE] = STRINGID_PKMNHIDUNDERWATER,
    [TWO_TURN_DIG] = STRINGID_PKMNDUGHOLE,
    [TWO_TURN_BOUNCE] = STRINGID_PKMNSPRANGUP,
    [TWO_TURN_SKY_DROP] = STRINGID_TOOKPJMNINTOTHESKY,
    [TWO_TURN_SKULL_BASH] = STRINGID_PKMNLOWEREDHEAD,
};
...
{
    STRINGID_PKMNPREVENTSPOISONINGWITH, STRINGID_PKMNPREVENTSBURNWITH, STRINGID_PKMNPREVENTSPARALYSISWITH, STRINGID_PKMNPREVENTSSLEEPWITH, STRINGID_PKMNWASNTAFFECTED
};
