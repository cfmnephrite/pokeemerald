...
static const u8 sText_MultitypeActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s ability changed to\n{B_SCR_ACTIVE_ABILITY} to match its type!");

const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    [STRINGID_MULTITYPEACTIVATES - 12] = sText_MultitypeActivates,
