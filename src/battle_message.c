...
static const u8 sText_StatsWontDecrease[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} won't go any lower!");
...
static const u8 sText_StatsWontIncrease2[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1} won't go any higher!");
static const u8 sText_StatsWontDecrease2[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1} won't go any lower!");
