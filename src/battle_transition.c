...
static bool8 Phase2_Mugshot_Func2(struct Task *task)
{
    ...
    LoadPalette(sPlayerMugshotsPals[gSaveBlockPtr->playerGender], 0xFA, 0xC);
...
static void Mugshots_CreateOpponentPlayerSprites(struct Task *task)
{
    ...
    task->tPlayerSpriteId = CreateTrainerSprite(PlayerGenderToFrontTrainerPicId(gSaveBlockPtr->playerGender), 272, 106, 0, gDecompressionBuffer);
