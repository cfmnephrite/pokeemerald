...
void SetZEffect(void)
{
    ...
    case Z_EFFECT_BOOST_CRITS:
        if (!(gBattleMons[gBattlerAttacker].volatileStatuses.dragonCheer || gBattleMons[gBattlerAttacker].volatileStatuses.focusEnergy))
        {
            gBattleMons[gBattlerAttacker].volatileStatuses.focusEnergy = TRUE;
