...
{
    CpuFill32(0, &gSaveBlockPtr->unk_322C, sizeof(gSaveBlockPtr->unk_322C));
    sub_801B180();
    sub_811F8BC();
}
...
{
    return &gSaveBlockPtr->unk_322C.wonderNews.data;
}

struct WonderCard *GetSavedWonderCard(void)
{
    return &gSaveBlockPtr->unk_322C.wonderCard.data;
}

struct MEventBuffer_3430_Sub *sav1_get_mevent_buffer_2(void)
{
    return &gSaveBlockPtr->unk_322C.buffer_310.data;
}

struct MysteryEventStruct *sub_801B044(void)
{
    return &gSaveBlockPtr->unk_322C.unk_340;
}

u16 *sub_801B058(void)
{
    return gSaveBlockPtr->unk_322C.unk_338;
}
...
bool32 sub_801B078(const struct WonderNews *src)
{
    ...
    s_DestroyWonderNews();
    gSaveBlockPtr->unk_322C.wonderNews.data = *src;
    gSaveBlockPtr->unk_322C.wonderNews.crc = CalcCRC16WithTable((void *)&gSaveBlockPtr->unk_322C.wonderNews.data, sizeof(struct WonderNews));
    return TRUE;
}

bool32 ValidateReceivedWonderNews(void)
{
    if (CalcCRC16WithTable((void *)&gSaveBlockPtr->unk_322C.wonderNews.data, sizeof(struct WonderNews)) != gSaveBlockPtr->unk_322C.wonderNews.crc)
        return FALSE;
    if (!sub_801B114(&gSaveBlockPtr->unk_322C.wonderNews.data))
        return FALSE;
...
{
    const struct WonderNews *data = &gSaveBlockPtr->unk_322C.wonderNews.data;
    if (data->unk_02 == 0)
        return FALSE;
...
static void s_DestroyWonderNews(void)
{
    CpuFill32(0, GetSavedWonderNews(), sizeof(gSaveBlockPtr->unk_322C.wonderNews.data));
    gSaveBlockPtr->unk_322C.wonderNews.crc = 0;
}
...
{
    const u8 *r5 = (const u8 *)&gSaveBlockPtr->unk_322C.wonderNews.data;
    u32 i;
...
bool32 sub_801B21C(const struct WonderCard *data)
{
    ...
    DestroyWonderCard();
    memcpy(&gSaveBlockPtr->unk_322C.wonderCard.data, data, sizeof(struct WonderCard));
    gSaveBlockPtr->unk_322C.wonderCard.crc = CalcCRC16WithTable((void *)&gSaveBlockPtr->unk_322C.wonderCard.data, sizeof(struct WonderCard));
    r2 = &gSaveBlockPtr->unk_322C.buffer_310.data;
    r1 = &gSaveBlockPtr->unk_322C.wonderCard.data;
    r2->unk_06 = r1->unk_02;
    return TRUE;
}
...
{
    if (gSaveBlockPtr->unk_322C.wonderCard.crc != CalcCRC16WithTable((void *)&gSaveBlockPtr->unk_322C.wonderCard.data, sizeof(struct WonderCard)))
        return FALSE;
    if (!sub_801B2CC(&gSaveBlockPtr->unk_322C.wonderCard.data))
        return FALSE;
...
{
    const struct WonderCard *data = &gSaveBlockPtr->unk_322C.wonderCard.data;
    if (data->unk_08_6 == 0)
        return FALSE;
...
static void sub_801B330(void)
{
    CpuFill32(0, &gSaveBlockPtr->unk_322C.wonderCard.data, sizeof(struct WonderCard));
    gSaveBlockPtr->unk_322C.wonderCard.crc = 0;
}

static void sub_801B368(void)
{
    CpuFill32(0, sav1_get_mevent_buffer_2(), 18 *sizeof(u16));
    gSaveBlockPtr->unk_322C.buffer_310.crc = 0;
}

u16 GetWonderCardFlagID(void)
{
    if (ValidateReceivedWonderCard())
        return gSaveBlockPtr->unk_322C.wonderCard.data.unk_00;
...
static int sub_801B4CC(void)
{
    ...
    data = &gSaveBlockPtr->unk_322C.wonderCard.data;
    if (data->unk_08_0 != 1)
        return 0;

    return sub_801B438(&gSaveBlockPtr->unk_322C.buffer_310.data, data->unk_09);
}

bool32 sub_801B508(const u16 *data)
{
    struct WonderCard *buffer = &gSaveBlockPtr->unk_322C.wonderCard.data;
    int size = buffer->unk_09;
    int i;
    if (!sub_801B4A4(data))
        return FALSE;

    if (sub_801B460(&gSaveBlockPtr->unk_322C.buffer_310.data, data, size))
        return FALSE;

    for (i = 0; i < size; i++)
    {
        if (gSaveBlockPtr->unk_322C.buffer_310.data.unk_08[1][i] == 0 && gSaveBlockPtr->unk_322C.buffer_310.data.unk_08[0][i] == 0)
        {
            gSaveBlockPtr->unk_322C.buffer_310.data.unk_08[1][i] = data[1];
            gSaveBlockPtr->unk_322C.buffer_310.data.unk_08[0][i] = data[0];
            return TRUE;
        }
    }
...
void sub_801B580(struct MEventStruct_Unk1442CC *data, bool32 a1)
{
    ...
    for (i = 0; i < 4; i++)
        data->unk_16[i] = gSaveBlockPtr->unk_322C.unk_338[i];

    CopyTrainerId(data->unk_4C, gSaveBlockPtr->playerTrainerId);
    StringCopy(data->unk_45, gSaveBlockPtr->playerName);
    for (i = 0; i < 6; i++)
        data->unk_50[i] = gSaveBlockPtr->easyChatProfile[i];
...
{
    struct WonderCard *data = &gSaveBlockPtr->unk_322C.wonderCard.data;
    if (data->unk_08_0 == 2)
    {
        u16 *dest = NULL;
        switch (command)
        {
        case 0:
            dest = &gSaveBlockPtr->unk_322C.buffer_310.data.unk_00;
            break;
        case 1:
            dest = &gSaveBlockPtr->unk_322C.buffer_310.data.unk_02;
            break;
        case 2:
            dest = &gSaveBlockPtr->unk_322C.buffer_310.data.unk_04;
            break;
        case 3:
            break;
        case 4:
...
u16 mevent_081445C0(u32 command)
{
    switch (command)
    {
        case 0:
        {
            ...
            if (data->unk_08_0 == 2)
            {
                struct MEventBuffer_3430_Sub *buffer = &gSaveBlockPtr->unk_322C.buffer_310.data;
...
bool32 sub_801B94C(u16 a0)
{
    ...
    if (gSaveBlockPtr->unk_322C.wonderCard.data.unk_00 != a0)
        return FALSE;
...
void sub_801B990(u32 a0, u32 a1)
{
    if (gUnknown_02022C70)
    {
        ...
        {
        case 2:
            sub_801BA8C(2, a1, gSaveBlockPtr->unk_322C.unk_344[1], 5);
            break;
        case 0:
            sub_801BA8C(0, a1, gSaveBlockPtr->unk_322C.unk_344[0], 5);
            break;
        case 1:
            sub_801BA8C(1, a1, gSaveBlockPtr->unk_322C.unk_344[0], 5);
            break;
        default:
            AGB_ASSERT(0);
        }
...
static void sub_801B9F8(void)
{
    CpuFill32(0, gSaveBlockPtr->unk_322C.unk_344, sizeof(gSaveBlockPtr->unk_322C.unk_344));
}
