...
void AddItemMenuActionTextPrinters(u8 windowId, u8 fontId, u8 left, u8 top, s8 letterSpacing, u8 lineHeight, u8 itemCount, const struct MenuAction *strs, const u8 *a8)
{
    ...
    printer.shift = GetFontAttribute(fontId, FONTATTR_UNKNOWN);
...
void sub_81995E4(u8 windowId, u8 itemCount, const struct MenuAction *strs, const u8 *a8)
{
    ...
    printer.shift = GetFontAttribute(1, FONTATTR_UNKNOWN);
    printer.letterSpacing = 0;
    printer.lineSpacing = 0;
    printer.x = 8;
    printer.currentX = 8;
...
void AddTextPrinterParameterized4(u8 windowId, u8 fontId, u8 left, u8 top, s8 letterSpacing, s8 lineSpacing, const u8 *color, s8 speed, const u8 *str)
{
    struct TextPrinterTemplate printer;
...
void AddTextPrinterParameterized5(u8 windowId, u8 fontId, const u8 *str, u8 left, u8 top, u8 speed, void (*callback)(struct TextPrinterTemplate *, u16), s8 letterSpacing, s8 lineSpacing)
{
    struct TextPrinterTemplate printer;
