...
{
    DoNamingScreen(0, gSaveBlockPtr->playerName, gSaveBlockPtr->playerGender, 0, 0, CB2_ReturnToFieldWithOpenMenu);
}

static void sub_80E509C(void)
{
    DoNamingScreen(1, gSaveBlockPtr->playerName, gSaveBlockPtr->playerGender, 0, 0, CB2_ReturnToFieldWithOpenMenu);
}

static void sub_80E50C4(void)
{
    DoNamingScreen(2, gSaveBlockPtr->playerName, gSaveBlockPtr->playerGender, 0, 0, CB2_ReturnToFieldWithOpenMenu);
}

static void sub_80E50EC(void)
{
    DoNamingScreen(3, gSaveBlockPtr->playerName, gSaveBlockPtr->playerGender, 0, 0, CB2_ReturnToFieldWithOpenMenu);
}
