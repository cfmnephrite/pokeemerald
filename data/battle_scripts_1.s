...
BattleScript_EffectAttackUpUserAlly:
	...
	attackstring
	ppreduce
	jumpifcanraise BS_ATTACKER, STAT_ATK, BattleScript_EffectAttackUpUserAlly_Works
	jumpifcannotraise BS_ATTACKER_PARTNER, STAT_ATK, BattleScript_ButItFailed
BattleScript_EffectAttackUpUserAlly_Works:
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	setallytonexttarget
	trychangestats STAT_BUFF_ATK_1, STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_OctolockEndTurn::
	...
	jumpifcannotlower2 BS_TARGET, STAT_DEF, STAT_SPDEF, BattleScript_OctolockEnd2
	trychangestats STAT_BUFF_DEF_SPD_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR
...
BattleScript_EffectTarShot:
	...
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_SPE_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR, NULL, TRUE
...
BattleScript_StuffCheeksEatBerry:
	...
	setbyte sBERRY_OVERRIDE, 0
	removeitem BS_ATTACKER
	trychangestats STAT_BUFF_DEF_2, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectDecorate:
	...
	attackstring
	ppreduce
	jumpifcannotraise2 BS_TARGET, STAT_ATK, STAT_SPATK, BattleScript_ButItFailed
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_SPA_1, STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
EffectCoaching_CheckAllyStats:
	jumpifcannotraise2 BS_TARGET, STAT_ATK, STAT_DEF, BattleScript_ButItFailed   @ ally at max atk, def
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_DEF_1, STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectStrengthSap:
	...
	trychangestats STAT_BUFF_ATK_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_ButItFailed, FALSE
	attackanimation
	waitanimation
...
BattleScript_VCreateStatLoss::
	trychangestats STAT_BUFF_DEF_SPD_SPE_1 | STAT_BUFF_NEGATIVE, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_NOT_PROTECT_AFFECTED | MOVE_EFFECT_CERTAIN, NULL, TRUE
	return
...
BattleScript_EffectPartingShot::
	...
	attackstring
	ppreduce
	jumpifcannotlower2 BS_TARGET, STAT_ATK, STAT_SPATK, BattleScript_CantLowerMultipleStats
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_SPA_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR
...
BattleScript_EffectAromaticMistWorks:
	jumpifcannotraise BS_TARGET, STAT_SPDEF, BattleScript_ButItFailed
	attackanimation
	waitanimation
...
BattleScript_EffectMagneticFluxCheckStats:
	jumpifcannotraise2 BS_TARGET, STAT_DEF, STAT_SPDEF, BattleScript_EffectMagneticFluxLoop
...
BattleScript_EffectGearUpCheckStats:
	jumpifcannotraise2 BS_TARGET, STAT_ATK, STAT_SPATK, BattleScript_EffectGearUpLoop
...
BattleScript_EffectAcupressureTry:
	...
	attackanimation
	waitanimation
	trychangestats NULL, MOVE_EFFECT_CERTAIN, NULL, BattleScript_MoveEnd
	goto BattleScript_MoveEnd
...
BattleScript_FlowerShieldLoop2:
	trychangestats STAT_BUFF_DEF_1, STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_FlowerShieldMoveTargetEnd, FALSE
	attackanimation
	waitanimation
	statchangeanimationandstrings
...
BattleScript_RototillerLoop:
	movevaluescleanup
	jumpifcannotraise2 BS_TARGET, STAT_ATK, STAT_SPATK, BattleScript_RototillerCantRaiseMultipleStats
...
BattleScript_EffectDefog:
	...
	jumpifcanlower BS_TARGET, STAT_EVASION, BattleScript_DefogWorks
...
BattleScript_DefogWorks:
	...
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_EVA_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR, NULL, TRUE
	copybyte gEffectBattler, gBattlerAttacker
...
BattleScript_EffectAutotomize:
	...
	attackstring
	ppreduce
	trychangestats STAT_BUFF_SPE_2, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_AutotomizeDoAnim
	attackanimation
	waitanimation
...
BattleScript_EffectToxicThread:
	attackcanceler
	jumpifsubstituteblocks BattleScript_ButItFailedAtkStringPpReduce
	jumpifcanlower BS_TARGET, STAT_SPEED, BattleScript_ToxicThreadWorks
...
BattleScript_EffectVenomDrenchCanBeUsed:
	jumpifcannotlower3 BS_TARGET, STAT_ATK, STAT_SPATK, STAT_SPEED, BattleScript_CantLowerMultipleStats
	accuracycheck BattleScript_ButItFailed, ACC_CURR_MOVE
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_SPA_SPE_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectShellSmash:
	...
	attackstring
	ppreduce
	jumpifcanlower2 BS_ATTACKER, STAT_DEF, STAT_SPDEF, BattleScript_ShellSmashTryDef
	jumpifcannotraise3 BS_ATTACKER, STAT_ATK, STAT_SPATK, STAT_SPEED, BattleScript_ButItFailed
BattleScript_ShellSmashTryDef::
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_DEF_1 | STAT_BUFF_NEGATIVE, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR | MOVE_EFFECT_CERTAIN
	trychangestats STAT_BUFF_ATK_SPA_SPE_2, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectGrowth:
	...
	attackstring
	ppreduce
	jumpifcannotraise2 BS_ATTACKER, STAT_ATK, STAT_SPATK, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	jumpifweatheraffected BS_ATTACKER, B_WEATHER_SUN, BattleScript_GrowthX2
	trychangestats STAT_BUFF_ATK_SPA_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_GrowthEnd
BattleScript_GrowthX2:
	trychangestats STAT_BUFF_ATK_SPA_2, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
...
BattleScript_EffectShiftGear:
	...
	attackstring
	ppreduce
	jumpifcannotraise2 BS_ATTACKER, STAT_SPEED, STAT_ATK, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_1 | STAT_BUFF_SPE_2, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectCoil:
	...
	attackstring
	ppreduce
	jumpifcannotraise3 BS_ATTACKER, STAT_ATK, STAT_DEF, STAT_ACC, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_DEF_ACC_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectQuiverDance:
	...
	attackstring
	ppreduce
	jumpifcannotraise3 BS_ATTACKER, STAT_SPATK, STAT_SPDEF, STAT_SPEED, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_SPA_SPD_SPE_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectVictoryDance:
	...
	attackstring
	ppreduce
	jumpifcannotraise3 BS_ATTACKER, STAT_ATK, STAT_DEF, STAT_SPEED, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_DEF_SPE_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectAttackAccUp:
	...
	attackstring
	ppreduce
	jumpifcannotraise2 BS_ATTACKER, STAT_ATK, STAT_ACC, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_1 | STAT_BUFF_ACC_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectTopsyTurvy:
	...
	ppreduce
	accuracycheck BattleScript_ButItFailed, NO_ACC_CALC_CHECK_LOCK_ON
	trytopsyturvy BattleScript_ButItFailed
	attackanimation
	waitanimation
...
BattleScript_TryTailwindAbilitiesLoop_WindRider:
	...
	trychangestats STAT_BUFF_ATK_1, STAT_CHANGE_ALLOW_PTR, NULL, TRUE
...
BattleScript_CaptivateCheckAcc:
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
	goto BattleScript_EffectStatChangeFromAttackString
...
BattleScript_EffectAttackUp::
	...
	goto BattleScript_EffectStatChange
...
BattleScript_EffectStatChange:
	attackcanceler
BattleScript_EffectStatChangeAfterAtkCanceler::
	jumpifsubstituteblocks BattleScript_ButItFailedAtkStringPpReduce
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
BattleScript_EffectStatChangeFromAttackString:
	attackstring
	ppreduce
	trychangestats NULL, STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_StatChangeDoAnim, FALSE
	attackanimation
	waitanimation
BattleScript_StatChangeDoAnim::
	statchangeanimationandstrings
	goto BattleScript_MoveEnd
...
BattleScript_VoltAbsorbHeal:
	...
	goto BattleScript_MoveHPRecoveryFromHit
...
.else
	setstatchanger STAT_EVASION, 1, FALSE
.endif
	goto BattleScript_EffectStatChangeAfterAtkCanceler
...
BattleScript_EffectCurse::
	...
	attackstring
	ppreduce
	jumpifcanlower BS_ATTACKER, STAT_SPEED, BattleScript_CurseTrySpeed
	jumpifcannotraise2 BS_ATTACKER, STAT_ATK, STAT_DEF, BattleScript_ButItFailed
BattleScript_CurseTrySpeed::
	copybyte gBattlerTarget, gBattlerAttacker
	setbyte sB_ANIM_TURN, 1
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_SPE_1 | STAT_BUFF_NEGATIVE, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR | MOVE_EFFECT_CERTAIN
	trychangestats STAT_BUFF_ATK_DEF_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectSwagger::
	...
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_2, STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_SwaggerTryConfuse
...
.if B_SPEED_BUFFING_RAPID_SPIN == GEN_8
	...
	seteffectwithchance
	trychangestats STAT_BUFF_SPE_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, TRUE
	tryfaintmon BS_TARGET
	moveendall
	end
.else
...
BattleScript_EffectSkullBash::
	...
	call BattleScriptFirstChargingTurn
	trychangestats STAT_BUFF_DEF_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, TRUE
	jumpifnoholdeffect BS_ATTACKER, HOLD_EFFECT_POWER_HERB, BattleScript_MoveEnd
	call BattleScript_PowerHerbActivation
	goto BattleScript_TwoTurnMovesSecondTurn
...
BattleScript_EffectStockpile::
	...
	jumpifcannotraise2 BS_ATTACKER, STAT_DEF, STAT_SPDEF, BattleScript_EffectStockpileEnd
	trychangestats STAT_BUFF_DEF_SPD_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
...
BattleScript_StockpileStatChangeDown:
	trychangestats NULL, MOVE_EFFECT_AFFECTS_USER, NULL, TRUE
	return
...
BattleScript_EffectMemento::
	...
	jumpifcannotlower2 BS_TARGET, STAT_ATK, STAT_SPATK, BattleScript_EffectMementoPrintNoEffect
	trychangestats STAT_BUFF_ATK_SPA_2 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR
...
BattleScript_EffectTickle::
	...
	attackstring
	ppreduce
	jumpifcannotlower2 BS_TARGET, STAT_ATK, STAT_DEF, BattleScript_ButItFailed
	accuracycheck BattleScript_ButItFailed, ACC_CURR_MOVE
	attackanimation
	waitanimation
...
BattleScript_EffectCosmicPower::
	...
	attackstring
	ppreduce
	jumpifcannotraise2 BS_ATTACKER, STAT_DEF, STAT_SPDEF, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_DEF_SPD_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectBulkUp::
	...
	attackstring
	ppreduce
	jumpifcannotraise2 BS_ATTACKER, STAT_ATK, STAT_DEF, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_DEF_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectCalmMind::
	...
	attackstring
	ppreduce
	jumpifcannotraise2 BS_ATTACKER, STAT_SPATK, STAT_SPDEF, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_SPA_SPD_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_EffectDragonDance::
	...
	attackstring
	ppreduce
	jumpifcannotraise2 BS_ATTACKER, STAT_ATK, STAT_SPEED, BattleScript_CantRaiseMultipleStats
	attackanimation
	waitanimation
	trychangestats STAT_BUFF_ATK_1 | STAT_BUFF_SPE_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	goto BattleScript_MoveEnd
...
BattleScript_FaintedMonSendOutNew:
	...
	jumpifbyte CMP_EQUAL, sSHIFT_SWITCHED, 0, BattleScript_FaintedMonShiftSwitched
...
BattleScript_WeaknessPolicy::
	...
	jumpifcannotraise2 BS_TARGET, STAT_ATK, STAT_SPATK, BattleScript_WeaknessPolicyRet
	playanimation BS_TARGET, B_ANIM_HELD_ITEM_EFFECT
	waitanimation
	printstring STRINGID_PKMNITEMACTIVATED
	trychangestats STAT_BUFF_ATK_SPA_2, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	removeitem BS_TARGET
...
BattleScript_TargetItemStatRaise::
	trychangestats NULL, 0, NULL, BattleScript_TargetItemStatRaiseRemoveItemRet, FALSE
	playanimation BS_TARGET, B_ANIM_HELD_ITEM_EFFECT
	waitanimation
	removeitem BS_TARGET
	printstring STRINGID_PKMNITEMACTIVATED
...
BattleScript_AttackerItemStatRaise::
	trychangestats NULL, MOVE_EFFECT_AFFECTS_USER, NULL, BattleScript_AttackerItemStatRaiseRet, FALSE
	playanimation BS_ATTACKER, B_ANIM_HELD_ITEM_EFFECT
	waitanimation
	removeitem BS_ATTACKER
	printstring STRINGID_PKMNITEMACTIVATED
...
BattleScript_RageIsBuilding::
	trychangestats STAT_BUFF_ATK_1, STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_RageIsBuildingEnd, FALSE
...
BattleScript_StickyWebOnSwitchIn::
	...
	trychangestats STAT_BUFF_SPE_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR
	restoretarget
...
BattleScript_GulpMissileNoDmgGulping:
	...
	trychangestats STAT_BUFF_DEF_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_NOT_PROTECT_AFFECTED
...
BattleScript_AngerShellActivates::
	call BattleScript_AbilityPopUp
	tryangershell BattleScript_ButItFailed
	trychangestats STAT_BUFF_DEF_SPD_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_ALLOW_PTR
	trychangestats STAT_BUFF_ATK_SPA_SPE_1, STAT_CHANGE_ALLOW_PTR
	return
...
BattleScript_AllStatsUp::
	trychangestats STAT_BUFF_ALL_STATS_1, STAT_CHANGE_ALLOW_PTR, BattleScript_AllStatsUpRet
...
BattleScript_AtkDefDown::
	trychangestats STAT_BUFF_ATK_1 | STAT_BUFF_DEF_1 | STAT_BUFF_NEGATIVE, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	return

BattleScript_DefSpDefDown::
	trychangestats STAT_BUFF_DEF_SPD_1 | STAT_BUFF_NEGATIVE, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	return

BattleScript_DefDownSpeedUp::
	jumpifcanlower BS_ATTACKER, STAT_DEF, BattleScript_DefDownSpeedUpTryDef
	jumpifcannotraise BS_ATTACKER, STAT_SPEED, BattleScript_DefDownSpeedUpRet
BattleScript_DefDownSpeedUpTryDef::
	trychangestats STAT_BUFF_DEF_1 | STAT_BUFF_NEGATIVE, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
...
BattleScript_CottonDownLoop:
	...
	trychangestats STAT_BUFF_SPE_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_NOT_PROTECT_AFFECTED
...
BattleScript_TryActivateSteadFast:
	trychangestats STAT_BUFF_SPE_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_MoveEnd, FALSE
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	stattextbuffer1 STAT_SPEED
...
BattleScript_SpeedBoostActivates::
	trychangestats STAT_BUFF_SPE_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_SpeedBoostActivatesEnd, FALSE
	call BattleScript_AbilityPopUp
	statchangeanimationandstrings
...
BattleScript_MoodyActivates::
	call BattleScript_AbilityPopUp
	jumpifhalfword CMP_EQUAL, sSTATCHANGER, 0x0, BattleScript_MoodyLower
	trychangestats NULL, MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN | STAT_CHANGE_NOT_PROTECT_AFFECTED
BattleScript_MoodyLower:
	jumpifhalfword CMP_EQUAL, sSAVED_STAT_CHANGER, 0x0, BattleScript_MoodyEnd
...
BattleScript_TryAdrenalineOrb::
	...
	copybyte sBATTLER, gBattlerTarget
	jumpifcannotraise BS_TARGET, STAT_SPEED, BattleScript_TryAdrenalineOrbRet
	playanimation BS_TARGET, B_ANIM_HELD_ITEM_EFFECT
	waitanimation
	printstring STRINGID_PKMNITEMACTIVATED
	trychangestats STAT_BUFF_SPE_1, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
...
.endif
	...
	copybyte sBATTLER, gBattlerAttacker
	trychangestats STAT_BUFF_ATK_1 | STAT_BUFF_NEGATIVE, STAT_CHANGE_NOT_PROTECT_AFFECTED | STAT_CHANGE_ALLOW_PTR
	copybyte sBATTLER, gBattlerTarget
...
BattleScript_MoveHPRecoveryFromHit_PPLoss::
	ppreduce
BattleScript_MoveHPRecoveryFromHit::
	attackstring
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE
...
BattleScript_MoveStatBoostFromHit_PPLoss::
	ppreduce
BattleScript_MoveStatBoostFromHit::
	attackstring
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	trychangestats NULL, STAT_CHANGE_ALLOW_PTR, NULL, TRUE
	clearsemiinvulnerablebit
	tryfaintmon BS_ATTACKER
	goto BattleScript_MoveEnd
...
BattleScript_WeakArmorActivates::
	call BattleScript_AbilityPopUp
	trychangestats STAT_BUFF_DEF_1 | STAT_BUFF_NEGATIVE, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	trychangestats STAT_BUFF_SPE_2, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR
	return

BattleScript_RaiseStatOnFaintingTarget::
	trychangestats NULL, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_RaiseStatOnFaintingTarget_End, FALSE
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	waitanimation
...
BattleScript_AttackerAbilityStatRaise::
	trychangestats NULL, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_AttackerAbilityStatRaise_End, FALSE
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	waitanimation
...
BattleScript_FellStingerRaisesStat::
	trychangestats NULL, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, TRUE
	return
...
BattleScript_BerryStatRaiseEnd2_Anim:
	trychangestats NULL, STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_BerryStatRaiseEnd2_End, FALSE
...
BattleScript_ApplyTotemVarBoost:
	trychangestats NULL, STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_TotemVarEnd
...
BattleScript_StatUpZMove::
	trychangestats NULL, MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, NULL, BattleScript_StatUpZMoveEnd, FALSE
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
...
BattleScript_EffectExtremeEvoboost::
	...
	attackstring
	ppreduce
	trychangestats STAT_BUFF_ALL_STATS_2, STAT_CHANGE_ALLOW_PTR, BattleScript_ButItFailed
	attackanimation
	waitanimation
	goto BattleScript_MoveEnd
...
BattleScript_TargetAbilityStatRaiseRet::
	...
	copybyte gBattlerAttacker, gBattlerTarget
	call BattleScript_AbilityPopUp
	trychangestats NULL, MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN
	return
...
BattleScript_BerserkGeneRet_Anim:
	jumpifcannotraise BS_SCRIPTING, STAT_ATK, BattleScript_BerserkGeneRet_TryConfuse
	playanimation BS_SCRIPTING, B_ANIM_HELD_ITEM_EFFECT, sB_ANIM_ARG1
